...
import es.api_idee.database.persistence.domain.Pagina;
import es.api_idee.database.persistence.domain.Tabla;
import es.api_idee.database.service.DatabaseService;
import es.api_idee.database.service.impl.DatabaseServiceImpl;
...
public class DatabaseWS {
	...
	private JSONArray addLinksToReponse(String url, String formato) {
		...
		String apiIdeeUrl = configProperties.getString("api-idee.url") + "api/database";
		JSONArray links = new JSONArray();
		links.put(createLink(apiIdeeUrl + url, "self", getTypeLinkByFormato(formato), "this document"));
		addAlternateLinks(links, apiIdeeUrl + url, formato);
