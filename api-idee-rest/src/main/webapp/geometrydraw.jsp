   ...
   %>
    <script type="text/javascript">
        ...
        buttonApi.addEventListener('click', function() {
            ...
            window.location.href = 'https://componentes-desarrollo.idee.es/api-idee//api-idee/?geometrydraw=' + posicion + '*' + collapsed + '*' + collapsible;
        })

        function crearPlugin(collapsed, collapsible, posicion) {
            mp = new IDEE.plugin.GeometryDraw({
                position: posicion,
                collapsed: collapsed,
