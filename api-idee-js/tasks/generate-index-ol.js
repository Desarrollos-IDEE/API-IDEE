...
const generateInfo = require('./generate-info-ol');
const generateOLInfo = require('./generate-ol-info');

const EXTERNS_LIBRARIES = require('./externs-libraries-ol');
...
if (require.main === module) {
  main().then(async (code) => {
    const filepath = path.join(__dirname, '..', 'src', 'index-ol.js');
    fse.outputFileSync(filepath, code);
    includeExterns(EXTERNS_LIBRARIES, '../src/index-ol.js');
    includeCustomNamespaces(CUSTOM_NAMESPACES, '../src/index-ol.js');
