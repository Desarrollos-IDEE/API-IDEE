...
const generateInfo = require('./generate-info-cesium');

const EXTERNS_LIBRARIES = require('./externs-libraries-cesium');
...
if (require.main === module) {
  main().then(async (code) => {
    const filepath = path.join(__dirname, '..', 'src', 'index-cesium.js');
    fse.outputFileSync(filepath, code);
    includeExterns(EXTERNS_LIBRARIES, '../src/index-cesium.js');
    includeCustomNamespaces(CUSTOM_NAMESPACES, '../src/index-cesium.js');
