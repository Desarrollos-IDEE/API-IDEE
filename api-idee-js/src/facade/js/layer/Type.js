...
/**
 * Transforma el tipo de capa a un tipo de capa soportado por API-IDEE.
 * - ⚠️ Advertencia: Este método no debe ser llamado por el usuario.
 *
 * @public
 * @function
 * @param {string} rawType Tipo de capa.
 * @returns {string} Tipo de capa soportado por API-IDEE.
 */
...
/**
 * Devuelve los tipos de capa soportados por API-IDEE.
 * - ⚠️ Advertencia: Este método no debe ser llamado por el usuario.
 * @public
 * @function
