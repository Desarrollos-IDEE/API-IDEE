...
```html
 <link href="https://componentes.cnig.es/api-idee/plugins/fulltoc/fulltoc.ol.min.css" rel="stylesheet" />
 <script type="text/javascript" src="https://componentes.cnig.es/api-idee/plugins/fulltoc/fulltoc.ol.min.js"></script>
```
...
Ejemplo:
```html
 <link href="https://componentes.cnig.es/api-idee/plugins/fulltoc/fulltoc-1.0.0.ol.min.css" rel="stylesheet" />
 <script type="text/javascript" src="https://componentes.cnig.es/api-idee/plugins/fulltoc/fulltoc-1.0.0.ol.min.js"></script>
```
