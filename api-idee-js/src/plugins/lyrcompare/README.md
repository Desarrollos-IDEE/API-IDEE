...
```html
 <link href="https://componentes.idee.es/api-idee/plugins/lyrcompare/lyrcompare.ol.min.css" rel="stylesheet" />
 <script type="text/javascript" src="https://componentes.idee.es/api-idee/plugins/lyrcompare/lyrcompare.ol.min.js"></script>
```
...
Ejemplo:
```html
 <link href="https://componentes.idee.es/api-idee/plugins/lyrcompare/lyrcompare-1.0.0.ol.min.css" rel="stylesheet" />
 <script type="text/javascript" src="https://componentes.idee.es/api-idee/plugins/lyrcompare/lyrcompare-1.0.0.ol.min.js"></script>
```
