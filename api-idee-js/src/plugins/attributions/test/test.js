...
const mp = new Attributions({
  ...
  // layer: new IDEE.layer.KML({ name: 'attributions', url: 'https://componentes-desarrollo.idee.es/api-idee/files/attributions/WMTS_PNOA_20170220/atribucionPNOA_Url.kml', displayInLayerSwitcher: false }),
});
