...
export default class MeasureBar extends IDEE.Plugin {
  /**
   * @classdesc
  ...
  static getJSONTranslations(lang) {
    ...
    return IDEE.language.getTranslation(lang).measurebar;
  }
  ...
  /**
   * This function compare if pluging recieved by param is instance of IDEE.plugin.MeasureBar
   *
   * @public
   * @function
    ...
    return {
      ...
      content: new Promise((success) => {
        const html = IDEE.template.compileSync(myhelp, {
          vars: {
            urlImages: `${IDEE.config.API_IDEE_URL}plugins/measurebar/images/`,
            translations: {
